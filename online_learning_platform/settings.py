...
SECRET_KEY = 'django-insecure-2(5!02zhq$d3m+cy(l@5_e=z!^r!_g2pi6@(6fx7z+v(=qx7$p'
...
MIDDLEWARE = [
    ...
    # No Cache Setting Middleware
    'core_app.middleware.NoCacheMiddleware',
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = '' # Replace with your default sender email
